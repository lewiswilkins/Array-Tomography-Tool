...
if __name__ == "__main__":
    ...
    for stack in image_stacks:
        ...
        print("Processing {0}.".format(stack_name))
        channel_file = ChannelFile.ChannelFile(name=stack_name,
                                               file_name=stack)
        ...
        channel_file.save_to_pickle(file_name="{0}/{1}.pickle".format(out_dir, stack_name))
